      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
        ...
        <div className="text-white space-y-6">
          ...
          <p className="text-gray-300 leading-relaxed">
            ...
            extensive collection of high-grade Shirts, Neelkanth Collection was
            established in the year at 2010.
          </p>

          <p className="text-gray-300 leading-relaxed">
            The product array offered is inclusive of optimum quality Casual
            Shirts, Formal Shirt, Partywear Shirts, Designer Shirts, Exclusive
            Shirt and Ethnic Shirt. With the support of latest machines and
            technology, our talented professionals precisely designed in
            accordance with the industry defined norms.
          </p>
        </div>
      </div>
    </section>
